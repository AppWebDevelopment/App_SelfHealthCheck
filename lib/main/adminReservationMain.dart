...
import 'package:selfchecker/main/adminReservationindividualList.dart';
import 'package:selfchecker/main/comNofitication.dart';
import 'package:selfchecker/main/adminReservationList.dart';
import 'package:selfchecker/data/companyInfo.dart';
import 'package:flutter/cupertino.dart';
import 'package:cupertino_icons/cupertino_icons.dart';

class AdminReservationMainPage extends StatefulWidget {
  @override
  _AdminReservationMainPageState createState() => _AdminReservationMainPageState();
}

class _AdminReservationMainPageState extends State<AdminReservationMainPage>
  ...
  Widget build(BuildContext context) {
    ...
    return CupertinoTabScaffold(
      ...
      tabBuilder: ((context, value){
        if(value==0)
          {return AdminReservationList(_dbRefComnameDate, _dbRefComnameUser, _dbRefComname, comInfo);}
        else
          {return AdminReservationIndividualPage( _dbRefComnameUser, _dbRefComname);}
      }),
